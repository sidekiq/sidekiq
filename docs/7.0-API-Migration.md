...
[Delayed Extensions][1] were disabled in Sidekiq 5 and [removed in Sidekiq 7][2].
...
This will no longer work. Either migrate code to use `Sidekiq::Job` or use the [3rd party gem `sidekiq-delay_extensions`][3]

Have more APIs which need a migration tip? Edit this file and open a PR!

[1]: https://github.com/sidekiq/sidekiq/wiki/Delayed-extensions
[2]: https://github.com/sidekiq/sidekiq/issues/5076
[3]: https://github.com/gemhome/sidekiq-delay_extensions

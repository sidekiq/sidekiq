...
module Sidekiq
  ...
  module Queues
    ...
    # Rspec syntax of change(QueueJob.jobs, :size). It keeps a reference
    # to the array. Because the array was dervied from a filter of the total
    # jobs enqueued, it appeared as though the array didn't change.
    #
    # To solve this, we'll keep 2 hashes containing the jobs. One with keys based
    # on the queue, and another with keys of the job names, so the array for
    # QueueJob.jobs is a straight reference to a real array.
    #
    # Queue-based hash:
    #
    # {
    ...
    class << self
      ...
      def delete_for(jid, queue, klass)
        ...
        jobs_by_type[klass].delete_if { |job| job["jid"] == jid }
      end

      def clear_for(queue, klass)
        jobs_by_queue[queue].clear
        jobs_by_type[klass].clear
      end
  ...
  module Job
    ...
    #
    # You can also clear and drain all jobs:
    #
    #   assert_equal 0, Sidekiq::Extensions::DelayedMailer.jobs.size
